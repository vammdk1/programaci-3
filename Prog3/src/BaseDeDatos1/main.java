...
public class main {
	...
	public static void main (String[] args) {
		...
		try {
			Connection conn = DriverManager.getConnection("jdbc:sqlite:basededatos.db");//establece la conexión con la base de datos
			
			Statement stmt = conn.createStatement(); //creamos OBLIGATORIAMENTE esta "declaraci�n" para poder jacer consultas
			...
			while (rs.next()) {
				...
				//hacemos print de la informaci�n
			...
			stmt.close(); // cierre de la declaraci�n
